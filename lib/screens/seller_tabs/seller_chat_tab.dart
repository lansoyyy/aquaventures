...
class SellerChatTab extends StatefulWidget {
  const SellerChatTab({super.key});

  @override
  _SellerChatTabState createState() => _SellerChatTabState();
}

class _SellerChatTabState extends State<SellerChatTab> {
